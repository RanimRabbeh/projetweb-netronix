...
require_once '../includes/database.php';  // Vérifiez que ce chemin est correct
...
$db = $database->getConnection();  // Appelle la méthode pour obtenir la connexion
...
<head>
    ...
    <link href="../front/front/slides/css/slides.css" rel="stylesheet" type="text/css">
    <link href="../front/front/slides/css/style.css" rel="stylesheet" type="text/css">
    <style>
        body {
            margin: 0;
            font-family: Arial, sans-serif;
            background: url('../front/front/slides/assets/img/background/5.jpeg') no-repeat center center fixed;
...
<div class="background">
    <nav class="panel top" style="position: relative; z-index: 3;">
        <div class="sections">
            <div class="left">
                <a href="#">
                    <img src="../front/front/slides/assets/img/logo.jfif" alt="Logo">
                </a>
            </div>
            <div class="right">
                <a href="../front/front/slides/index.html">Retour à l'accueil</a>
            </div>
        </div>
    </nav>
    <section class="content">
        <div class="profile-container">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="../front/front/slides/index.html" style="color: #007bff;">accueil</a>
            </div>
        </div>
    </section>
</div>
