...
<nav class="panel top">
  <div class="sections desktop">
    ...
    <div class="center">
    <img src="logo.png" alt="Logo"  style="width: 100px; height: 100 px;">
    ...
    <div class="right"><a class="button blue gradient" href="#pp"><Label>Se connecter</Label></a><a class="button green gradient" href="https://freehtml5.co/slides" target="_blank">Télécharger l'application</a></div>
  </div>
...
<section class="slide fade-6 kenBurns">
  ...
  <div class="background" style="background-image:url(../assets/img/background/2.jpeg)"></div>
</section>
