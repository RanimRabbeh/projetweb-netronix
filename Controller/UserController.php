...
class UserController {
    ...
    public function sendResetCode($email) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'laribi.ahmed7016@gmail.com'; // Remplacez par votre email
            $mail->Password   = 'uzxu glst awkg tpww';  // Remplacez par votre mot de passe
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port       = 587;

            $mail->setFrom('laribi.ahmed7016@gmail.com', 'Support');
